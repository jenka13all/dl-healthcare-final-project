...
care_true = pickle.load(open(resources_path + 'care_true.pkl', 'rb'))
care_preds = pickle.load(open(resources_path + 'care_preds.pkl', 'rb'))

print_metrics_multilabel(care_true, care_preds)
