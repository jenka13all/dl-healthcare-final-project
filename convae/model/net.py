...
class ehrEncoding(nn.Module):
    ...
    def __init__(self, vocab_size, max_seq_len,
        ...
        # 15756 x 100
        self.embedding = nn.Embedding(vocab_size, self.emb_size, padding_idx=0)
        ...
        # emb_size=100, ch_l1=50, kernel_size=5, padding=2
        self.cnn_l1 = nn.Conv1d(self.emb_size, self.ch_l1, kernel_size=kernel_size, padding=self.padding)
