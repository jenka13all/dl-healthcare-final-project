...
seq_file = open('data/testpat-ehrseq.csv', 'w')
...
for subject_dir in tqdm(os.listdir(mimic3_pat_path), desc='Iterating over subjects'):
    #TEST
    if subject_dir == '99469':
        print('subject_dir', str(subject_dir))
        ...
        for adm_id in sorted_admissions:
            ...
            print(str(adm_id), str(len(sorted_events)))
...
# python3 create_diagnosis_seq.py ../../mimic3-benchmarks/data/root train